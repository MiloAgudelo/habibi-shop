    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
            <div class="flex justify-between items-center">
                ...
                <button type="button" onclick="document.getElementById('userForm').classList.remove('hidden')"
            ...
            <div class="px-4 py-5 sm:p-6">
                <form action="" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="button" onclick="document.getElementById('userForm').classList.add('hidden')"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="?action=edit&id=<?php echo htmlspecialchars($usuario['id'] ?? ''); ?>" 
                                            class="text-indigo-600 hover:text-indigo-900 mr-3">Editar</a>
                                        <a href="?action=delete&id=<?php echo htmlspecialchars($usuario['id'] ?? ''); ?>" 
